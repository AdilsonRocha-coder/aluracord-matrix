        ...
        {`
          ${Tag} {
            color: ${appConfig.theme.colors.neutrals[
              '000'
            ]}; //aqui o '000' é a paleta de cores 'neutrals' que temos no config.json
            font-size: 24px;
            font-weighht: 600;
          }
        `}
        ...
        >
          ...
          >
            <Image
              ...
              src={`https://avatars.githubusercontent.com/u/62582324?s=400&u=a4bcf0aff58a06ce8ffb2c2648a4b82360209aeb&v=4${username}.png`}
            />
            <Text
              variant="body4"
              styleSheet={{
